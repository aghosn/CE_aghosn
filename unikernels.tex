...
%Security, type safe, single address space, X forbids W, smaller sized. 
%Other hand, break backward compatibility and requires to rewrite the entire stack from scratch.
