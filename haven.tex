...
\adrien{Not sure now, maybe clarify how data is protected (not accessible in CPU, and encrypted in main memory and integrity protected.)}
\adrien{Attestation mechanism must be added as well (the hash inside the SECS).}
