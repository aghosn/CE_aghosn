...
Since the paper was published in 1995 and Aegis evaluated on the hardware available back then, we ignore the measured numerical values and focus on the relative performance of the Exokernel compared to Ultrix, a traditional monolithic kernel.
