...
From these observations, we understand that the architecture of current operating systems, that exposes only rigid high-level abstractions, is becoming obsolete and must be replaced.
